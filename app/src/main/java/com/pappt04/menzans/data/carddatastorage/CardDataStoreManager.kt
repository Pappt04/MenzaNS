package com.pappt04.menzans.data.carddatastorage
...
import com.pappt04.menzans.data.mealdatastorage.mealpreferenceDataStore
...
class CardDataStoreManager(val context: Context) {
    ...
    fun getFromDataStore() = context.cardpreferenceDataStore.data.map {
    ...
    suspend fun clearDataStore() = context.cardpreferenceDataStore.edit {
