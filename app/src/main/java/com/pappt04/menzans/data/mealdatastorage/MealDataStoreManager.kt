...
import com.pappt04.menzans.data.settingsdatastorage.settingspreferenceDataStore
...
class MealDataStoreManager(val context: Context) {
    ...
    fun getFromDataStore() =context.mealpreferenceDataStore.data.map {
    ...
    suspend fun clearDataStore() = context.mealpreferenceDataStore.edit {
